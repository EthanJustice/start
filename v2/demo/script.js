...
const linksList = {
    "items": [
        {
            "displayText": "r/startpages",
            "destination": "https://reddit.com/r/startpages",
            "color": "cyan"
        },
        {
            "displayText": "MDN",
...
function weather() {
    fetch('https://www.metaweather.com/api/location/2514815').then(resp => resp.json()).then(function(data) {
